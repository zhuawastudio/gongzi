               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户编号" prop="yuangongUuidNumber">
                       <el-input v-model="ruleForm.yuangongUuidNumber"
                                 placeholder="用户编号" clearable  :readonly="ro.yuangongUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户姓名" prop="yuangongName">
                       <el-input v-model="ruleForm.yuangongName"
                                 placeholder="用户姓名" clearable  :readonly="ro.yuangongName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户手机号" prop="yuangongPhone">
                       <el-input v-model="ruleForm.yuangongPhone"
                                 placeholder="用户手机号" clearable  :readonly="ro.yuangongPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户身份证号" prop="yuangongIdNumber">
                       <el-input v-model="ruleForm.yuangongIdNumber"
                                 placeholder="用户身份证号" clearable  :readonly="ro.yuangongIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户邮箱" prop="yuangongEmail">
                       <el-input v-model="ruleForm.yuangongEmail"
                                 placeholder="用户邮箱" clearable  :readonly="ro.yuangongEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="账户状态" prop="jinyongTypes">
                        <el-select v-model="ruleForm.jinyongTypes" :disabled="ro.jinyongTypes" placeholder="请选择账户状态">
                            <el-option
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    yuangongUuidNumber: true,
                    yuangongName: false,
                    yuangongPhone: false,
                    yuangongIdNumber: false,
                    yuangongPhoto: false,
                    sexTypes: false,
                    bumenTypes: false,
                    zhiweiTypes: false,
                ...
                ruleForm: {
                    username: '',
                    password: '',
                    yuangongUuidNumber: new Date().getTime(),
                    yuangongName: '',
                    yuangongPhone: '',
                    yuangongIdNumber: '',
                    yuangongPhoto: '',
