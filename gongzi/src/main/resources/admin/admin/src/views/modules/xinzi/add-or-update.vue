    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="提成" prop="jiangjinJine">
                       <el-input v-model="ruleForm.jiangjinJine"
                                 placeholder="提成" clearable  :readonly="ro.jiangjinJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="提成" prop="jiangjinJine">
                           <el-input v-model="ruleForm.jiangjinJine"
                                     placeholder="提成" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="绩效" prop="jixiaoJine">
                       <el-input v-model="ruleForm.jixiaoJine"
                                 placeholder="绩效" clearable  :readonly="ro.jixiaoJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="绩效" prop="jixiaoJine">
                           <el-input v-model="ruleForm.jixiaoJine"
                                     placeholder="绩效" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="津贴" prop="butieJine">
                       <el-input v-model="ruleForm.butieJine"
                                 placeholder="津贴" clearable  :readonly="ro.butieJine"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="津贴" prop="butieJine">
                           <el-input v-model="ruleForm.butieJine"
                                     placeholder="津贴" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jixiaoJine: [
                              { required: true, message: '绩效不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
